...
const landingTranslations = {
  en: {
    ...
    navCta: 'Ask AI Assistant →',
    logout: 'Logout',
    heroBadge: 'Powered by Artificial Intelligence · Beta',
    heroTitle: 'Your <span class="accent">Smart NYSC</span><br>Assistant',
    heroSub: 'Get instant, accurate answers about your NYSC journey — from registration and camp procedures to posting, CDS, and allowances. Available 24/7 in English, Yoruba, Hausa, and Igbo.',
    heroAsk: 'Ask AI Assistant',
  ...
  yo: {
    ...
    navCta: 'Beere AI →',
    logout: 'Jìwọ́ sílẹ̀',
    heroBadge: 'Tí a fi AI ṣe agbára · Beta',
    heroTitle: 'Olùrànlọ́wọ́ <span class="accent">NYSC</span><br>Rẹ',
    heroSub: 'Gba idahun lẹsẹkẹsẹ nipa irin-ajo NYSC rẹ — lati ìforúkọsilẹ̀ sí ìkúnlẹ̀, ipò, CDS, àti owo-oṣù. Wà lọwọlọwọ́ ni gbogbo ọjọ́ àti gbogbo àkókò ni English, Yoruba, Hausa, àti Igbo.',
    heroAsk: 'Beere AI',
    heroSee: 'Wo Àwọn ẹya',
  ...
  ha: {
    ...
    navCta: 'Tambaya AI →',
    logout: 'Fita',
    heroBadge: 'An yi ta da Artificial Intelligence · Beta',
    heroTitle: 'Mataimakin <span class="accent">NYSC</span><br>ɗinku',
    heroSub: 'Samun amsa nan take game da NYSC ɗinku — daga rajista da shirye-shirye na sansani, zuwa biyan kuɗi, CDS, da sauran abubuwa. Akwai 24/7 a English, Yoruba, Hausa, da Igbo.',
    heroAsk: 'Tambaya AI',
  ...
  ig: {
    ...
    navCta: 'Ajụ AI →',
    logout: 'Pụọ',
    heroBadge: 'Eji Artificial Intelligence · Beta',
    heroTitle: 'Ndịaka <span class="accent">NYSC</span><br>Gị',
    heroSub: 'Nweta azịza ngwa ngwa gbasara NYSC gị — site na ndebanye, usoro camp, ịtọ ọrụ, CDS, na ụgwọ. Ọ dị n’oge 24/7 na English, Yoruba, Hausa, na Igbo.',
    heroAsk: 'Ajụ AI',
    heroSee: 'Lee Ụdị',
    statCorps: 'Ndị NYSC',
