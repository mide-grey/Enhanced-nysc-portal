...
# ─── Security ─────────────────────────────────────────────────
SECRET_KEY = config('SECRET_KEY', default='django-insecure-change-this-in-production-nysc-2025')
...
# ─── Free AI Chatbot Config ───────────────────────────────────
# Get your FREE Gemini key at: https://aistudio.google.com/app/apikey
# The chatbot works WITHOUT this key (uses built-in knowledge base)
# With the key, responses are much richer and context-aware
